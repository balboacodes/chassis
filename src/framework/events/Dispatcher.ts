...
export class Dispatcher {
     ...
     */
    public listen(
        events: QueuedClosure | (() => unknown) | unknown[] | Class | string,
        listener?: QueuedClosure | (() => unknown) | unknown[] | Class,
    ): void {
    ...
    //      * @return bool
    //      */
    //     public hasWildcardListeners(eventName)
    //     {
     ...
     */
    public dispatch(event: string | object, payload: unknown = [], halt: boolean = false): unknown[] | null {
    ...
    //      * @return \Closure
    //      */
    //     public makeListener(listener, wildcard = false)
    //     {
    ...
    //      * @return \Closure
    //      */
    //     public createClassListener(listener, wildcard = false)
    //     {
    //         return function (event, payload) use (listener, wildcard) {
    //             if (wildcard) {
    ...
    //      * @return mixed
    //      */
    //     public defer(callable callback, ?array events = null)
    //     {
