import { default as CallableDispatcherContract } from '../contracts/routing/CallableDispatcher.ts';

export default class CallableDispatcher implements CallableDispatcherContract {
