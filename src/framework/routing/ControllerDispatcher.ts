import { default as ControllerDispatcherContract } from '../contracts/routing/ControllerDispatcher.ts';

export default class ControllerDispatcher implements ControllerDispatcherContract {
