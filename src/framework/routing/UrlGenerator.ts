import { empty } from '@balboacodes/php-utils';
import { Request } from '../http/Request.ts';
import { tap } from '../support/helpers.ts';
...
export class UrlGenerator {
     ...
     */
    public constructor(routes: RouteCollection, request: Request, assetRoot?: string) {
        this.routes = routes;
     ...
     */
    public defaults(defaults: Record<string, unknown>): void {
    ...
    public setRequest(request: Request): void {
        ...
        tap(this.routeGenerator?.defaultParameters ?? {}, (defaults) => {
