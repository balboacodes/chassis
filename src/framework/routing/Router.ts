import BindingRegistrar from '../contracts/routing/BindingRegistrar.ts';
import { default as RegistrarContract } from '../contracts/routing/Registrar.ts';

/**
 * @mixin RouteRegistrar
 */
export default class Router implements BindingRegistrar, RegistrarContract {
    //     use Macroable {
    //         __call as macroCall;
    //     }
    //     use Tappable;
