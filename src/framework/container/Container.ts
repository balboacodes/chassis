// @ts-nocheck
import { Container as ContainerContract } from '../contracts/container/Container.ts';
import { ArrayAccess } from '../contracts/php/ArrayAccess.ts';

export class Container implements ArrayAccess, ContainerContract {
    /**
     ...
     * @return void
     */
    public whenHasAttribute(attribute, handler) {
     ...
     */
    protected getScopedTyped(reflection): ?string {
     ...
     * @return \Closure
     */
    protected getClosure(abstract, concrete) {
        // return  (container, parameters = []) use (abstract, concrete) {
     ...
     * @return bool
     */
    public hasMethodBinding(method) {
     ...
     * @return void
     */
    public bindMethod(method, callback) {
     ...
     * @return string
     */
    protected parseBindMethod(method) {
        // if (is_array(method)) {
     ...
     * @return mixed
     */
    public callMethodBinding(method, instance) {
     ...
     * @return void
     */
    public bindIf(abstract, concrete = null, shared = false) {
     ...
     * @return void
     */
    public singleton(abstract, concrete = null) {
     ...
     * @return void
     */
    public singletonIf(abstract, concrete = null) {
        // if (! this->bound(abstract)) {
     ...
     * @throws \ReflectionException
     */
    protected closureReturnTypes(closure) {
     ...
     */
    public extend(abstract, closure) {
        // abstract = this->getAlias(abstract);
        // if (isset(this->instances[abstract])) {
     ...
     * @return TInstance
     */
    public instance(abstract, instance) {
     ...
     * @return void
     */
    protected removeAbstractAlias(searched) {
    ...
    public tagged(tag) {
        ...
        //     return [];
        // }
        // return new RewindableGenerator( () use (tag) {
     ...
     * @return mixed
     */
    public rebinding(abstract, callback) {
     ...
     * @return mixed
     */
    public refresh(abstract, target, method) {
        // return this->rebinding(abstract,  (app, instance) use (target, method) {
     ...
     * @return array
     */
    protected getReboundCallbacks(abstract) {
     ...
     * @return \Closure
     */
    public wrap(callback, parameters = []) {
     ...
     * @throws \InvalidArgumentException
     */
    public call(callback, parameters = [], defaultMethod = null) {
     ...
     */
    public makeWith(abstract, parameters = []) {
     ...
     * @throws \Illuminate\Contracts\Container\BindingResolutionException
     */
    public make(abstract, parameters = []) {
     ...
     * @return mixed
     */
    protected getConcrete(abstract) {
     ...
     * @return bool
     */
    protected isBuildable(concrete, abstract) {
     ...
     * @throws \Illuminate\Contracts\Container\CircularDependencyException
     */
    public build(concrete) {
        // If the concrete type is actually a Closure, we will just execute it and
        // hand back the results of the s, which allows s to be
     ...
     * @throws \Illuminate\Contracts\Container\BindingResolutionException
     */
    protected resolveDependencies(dependencies) {
        // results = [];
     ...
     * @return array
     */
    protected getLastParameterOverride() {
     ...
     * @throws \Illuminate\Contracts\Container\BindingResolutionException
     */
    protected resolvePrimitive(parameter) {
     ...
     * @throws \Illuminate\Contracts\Container\BindingResolutionException
     */
    protected resolveClass(parameter) {
     ...
     * @return mixed
     */
    protected resolveVariadicClass(parameter) {
        // className = Util::getParameterClassName(parameter);
     ...
     * @return mixed
     */
    public resolveFromAttribute(attribute) {
     ...
     * @throws \Illuminate\Contracts\Container\BindingResolutionException
     */
    protected unresolvablePrimitive(parameter) {
     ...
     * @return void
     */
    public beforeResolving(abstract, callback = null) {
     ...
     * @return void
     */
    public resolving(abstract, callback = null) {
        // if (is_string(abstract)) {
        //     abstract = this->getAlias(abstract);
        // }
     ...
     * @return void
     */
    public afterResolving(abstract, callback = null) {
        // if (is_string(abstract)) {
        //     abstract = this->getAlias(abstract);
        // }
        // if (abstract instanceof Closure && is_null(callback)) {
     ...
     * @return void
     */
    public afterResolvingAttribute(attribute, callback) {
     ...
     * @return void
     */
    protected fireBeforeResolvingCallbacks(abstract, parameters = []) {
     ...
     * @return void
     */
    protected fireBeforeCallbackArray(abstract, parameters, callbacks) {
        // foreach (callbacks as callback) {
     ...
     * @return void
     */
    protected fireResolvingCallbacks(abstract, object) {
     ...
     * @return void
     */
    protected fireAfterResolvingCallbacks(abstract, object) {
     ...
     * @return void
     */
    public fireAfterResolvingAttributeCallbacks(attributes, object) {
     ...
     * @return array
     */
    protected getCallbacksForType(abstract, object, callbacksPerType) {
        // results = [];
     ...
     * @return void
     */
    protected fireCallbackArray(object, callbacks) {
        // foreach (callbacks as callback) {
     ...
     * @return void
     */
    protected dropStaleInstances(abstract) {
     ...
     * @return void
     */
    public forgetInstance(abstract) {
     ...
     * @return void
     */
    public resolveEnvironmentUsing(callback) {
     ...
     * @return bool
     */
    public currentEnvironmentIs(environments) {
     ...
     */
    public static setInstance(container = null) {
