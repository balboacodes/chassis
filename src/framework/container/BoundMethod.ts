...
export class BoundMethod {
    ...
    public static call(container: Container, callback: Function, parameters: any[] = [], defaultMethod?: string): any {
        ...
        // }
        // return static::callBoundMethod(container, callback, () use (container, callback, parameters) {
    ...
    protected static callBoundMethod(container: Container, callback: Function, defaultValue: any): any {
    ...
    protected static normalizeMethod(callback: Function): string {
    ...
    protected static getMethodDependencies(container: Container, callback: Function, parameters: any[] = []): any[] {
        // dependencies = [];
    ...
    protected static getCallReflector(callback: Function): any {
     ...
     */
    protected static addDependencyForCallParameter(
        container: Container,
