...
export class EventServiceProvider extends ServiceProvider {
     ...
     */
    protected static eventDiscoveryPaths?: string[];
     ...
     */
    public static setEventDiscoveryPaths(paths: string[]): void {
        EventServiceProvider.eventDiscoveryPaths = paths;
    }
     ...
     */
    public static disableEventDiscovery(): void {
