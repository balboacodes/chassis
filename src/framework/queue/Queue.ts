export default abstract class Queue {
     ...
     */
    protected static createPayloadCallbacks: ((connection: unknown, queue: unknown, payload: unknown[]) => unknown)[] =
        [];
     ...
     */
    public static createPayloadUsing(
        callback?: (connection: unknown, queue: unknown, payload: unknown[]) => unknown,
    ): void {
        if (!callback) {
            Queue.createPayloadCallbacks = [];
        } else {
