...
export class Repository {
     ...
     */
    public getMany(keys: Record<string, unknown> | string[]): Record<string, unknown> {
     ...
     */
    public string(key: string, defaultValue?: (() => string | undefined) | string): string {
     ...
     */
    public integer(key: string, defaultValue?: (() => number | undefined) | number): number {
        const value = this.get(key, defaultValue);
     ...
     */
    public float(key: string, defaultValue?: (() => number | undefined) | number): number {
        const value = this.get(key, defaultValue);
     ...
     */
    public boolean(key: string, defaultValue?: (() => boolean | undefined) | boolean): boolean {
        const value = this.get(key, defaultValue);
     ...
     */
    public array(key: string, defaultValue?: (() => unknown[] | undefined) | unknown[]): unknown[] {
        const value = this.get(key, defaultValue);
     ...
     */
    public set(key: Record<string, unknown> | string, value: unknown = null): void {
